...
export class ArtworkPriceSet extends ethereum.Event {
  get params(): ArtworkPriceSet__Params {
    return new ArtworkPriceSet__Params(this);
  }
}

export class ArtworkPriceSet__Params {
  _event: ArtworkPriceSet;

  constructor(event: ArtworkPriceSet) {
    this._event = event;
  }
...
export class ArtworkSold extends ethereum.Event {
  get params(): ArtworkSold__Params {
    return new ArtworkSold__Params(this);
  }
}

export class ArtworkSold__Params {
  _event: ArtworkSold;

  constructor(event: ArtworkSold) {
    this._event = event;
  }
...
export class Contract extends ethereum.SmartContract {
  ...
  artworkToCurrentPrice(param0: BigInt): BigInt {
    let result = super.call(
      "artworkToCurrentPrice",
      "artworkToCurrentPrice(uint256):(uint256)",
  ...
  try_artworkToCurrentPrice(param0: BigInt): ethereum.CallResult<BigInt> {
  ...
  failedTransferCredits(param0: Address): BigInt {
    let result = super.call(
      "failedTransferCredits",
      "failedTransferCredits(address):(uint256)",
  ...
  try_failedTransferCredits(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "failedTransferCredits",
      "failedTransferCredits(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
...
export class BuyArtworkCall extends ethereum.Call {
  get inputs(): BuyArtworkCall__Inputs {
    return new BuyArtworkCall__Inputs(this);
  }

  get outputs(): BuyArtworkCall__Outputs {
    return new BuyArtworkCall__Outputs(this);
  }
}

export class BuyArtworkCall__Inputs {
  _call: BuyArtworkCall;

  constructor(call: BuyArtworkCall) {
    this._call = call;
  }

  get _artworkId(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class BuyArtworkCall__Outputs {
  _call: BuyArtworkCall;
